...
describe("aws-transport:", () => {
  ...
  describe("publish:", () => {
    ...
    it("should catch invalid routingKey params", () => {
      return transport
        .publish(35353535, { message: "hello" }, { host: "localhost", port: 3000 })
        .then(() => {
          throw new Error("Failed to catch invalid input.");
        })
        .catch((err) => {
    ...
    it("should catch invalid correlationId params", () => {
      return transport
        .publish("bob", {}, { correlationId: 44444, host: "localhost", port: 3000 })
        .then(() => {
          throw new Error("Failed to catch invalid input.");
        })
        .catch((err) => {
    ...
    it("should catch invalid initiator params", () => {
      return transport
        .publish("bob", {}, { initiator: 44444, host: "localhost", port: 3000 })
        .then(() => {
          throw new Error("Failed to catch invalid input.");
        })
        .catch((err) => {
